...
const Search = ({ handleFilterButtonClick, handleClearSearch, setActiveField, showFilter,  setFilterValue, setCurrentPage, handleCorsClick}) => {
    ...
    return(
        <div className="">
            <Cors handleCorsClick={handleCorsClick} />
